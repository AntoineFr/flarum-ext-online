    ...
    form() {
        return [
            <div className="Form-group">
                ...
                <input required className="FormControl" type="number" bidi={this.setting('antoinefr-online.titleoflist')}></input>
                <label>{app.translator.trans('antoinefr-online.admin.settings.displaymax')}</label>
                <input required className="FormControl" type="text" bidi={this.setting('antoinefr-online.displaymax')}></input>
            </div>
        ];
    }
}